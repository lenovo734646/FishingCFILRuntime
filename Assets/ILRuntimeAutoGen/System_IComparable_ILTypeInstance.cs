...
{   
    public class IComparable_1_ILTypeInstanceAdapter : CrossBindingAdaptor
    {
        ...
        {
            CrossBindingFunctionInfo<ILRuntime.Runtime.Intepreter.ILTypeInstance, System.Int32> mCompareTo_0 = new CrossBindingFunctionInfo<ILRuntime.Runtime.Intepreter.ILTypeInstance, System.Int32>("CompareTo");
            ...
            {
                return mCompareTo_0.Invoke(this.instance, other);
            }
