...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_CodedInputStream_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SkipLastField_1);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.Action<Google.Protobuf.CodedInputStream>)};
            ...
            app.RegisterCLRMethodRedirection(method, ReadUInt32_8);
            args = new Type[]{};
            method = type.GetMethod("ReadFixed32", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ReadFixed32_9);
            args = new Type[]{typeof(System.Action<Google.Protobuf.CodedInputStream>)};
            method = type.GetMethod("ReadRepeated", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ReadRepeated_10);
            args = new Type[]{};
        ...
        static StackObject* SkipLastField_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ReadMessage_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<Google.Protobuf.CodedInputStream> @decoder = (System.Action<Google.Protobuf.CodedInputStream>)typeof(System.Action<Google.Protobuf.CodedInputStream>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.ReadMessage(@decoder);

            return __ret;
        }

        static StackObject* ReadUInt32_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ReadFixed32_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ReadRepeated_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.ReadRepeated(@decoder);
