    ...
    unsafe class System_Threading_Interlocked_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("CompareExchange", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>), typeof(System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>).MakeByRefType(), typeof(System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>), typeof(System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* CompareExchange_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance> @comparand = (System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance> @value = (System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance> @location1 = (System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)8);


            var result_of_this_method = System.Threading.Interlocked.CompareExchange<System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>>(ref @location1, @value, @comparand);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as System.EventHandler<ILRuntime.Runtime.Intepreter.ILTypeInstance>[];
                        instance_of_arrayReference[ptr_of_this_method->ValueLow] = @location1;
                    }
                    break;
            }
