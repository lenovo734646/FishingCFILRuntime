...
namespace Com.TheFallenGames.OSA.Core
{
	...
	{
		public const string OSA_VERSION_STRING = "5.1.1";
		...
		public const string OSA_PATH_IN_PROJECT = "Assets/" + OSA_PATH_IN_ASSETS;
		public const string OSA_PATH_IN_ASSETS = "Plugins/" + OSA_PATH_IN_PLUGINS;
		public const string OSA_PATH_IN_PLUGINS = "Com.TheFallenGames/OSA";
